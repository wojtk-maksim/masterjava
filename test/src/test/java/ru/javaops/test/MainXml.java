package ru.javaops.test;

import com.google.common.base.Splitter;
import com.google.common.io.Resources;
import j2html.tags.ContainerTag;
import one.util.streamex.StreamEx;
import ru.javaops.upload.schema.ObjectFactory;
import ru.javaops.upload.schema.Payload;
import ru.javaops.upload.schema.Project;
import ru.javaops.upload.schema.User;
import ru.javaops.upload.util.JaxbParser;
import ru.javaops.upload.util.Schemas;
import ru.javaops.upload.util.StaxStreamProcessor;
import ru.javaops.upload.util.XsltProcessor;
...
public class MainXml {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Writer writer = Files.newBufferedWriter(Paths.get("out/users.jsp"))) {
            writer.write(html);
        }
